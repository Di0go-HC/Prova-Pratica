...
# Exemplo de dados hipotéticos extraídos do seu dataset
# Aqui estamos usando apenas colunas numéricas para simplificação
data = {
...
# A partir do gráfico de cotovelo, podemos definir o número de clusters ideal
